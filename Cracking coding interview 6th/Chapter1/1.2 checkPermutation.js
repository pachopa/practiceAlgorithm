...
// false
const a = ["abcdefghiz", "ihgfedcbaa"];
const b = ["1a1", "11"];
const c = ["1122334455667788", "9911223344556677"];
const d = ["45678", "1239"];

// true
const e = ["abcdefghi", "ihgfedcba"];
const f = ["1a1", "a11"];
const g = ["1234567812345678", "8877665544332211"];
const h = ["icarraci", "carcarii"];

console.log(checkPermutation(h));
